...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '3.110.81.27:8080'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '3.110.81.27:8080')) if not ON_HEROKU or getenv('FQDN', '3.110.81.27:8080') else APP_NAME+'.herokuapp.com'
